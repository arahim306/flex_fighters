...
package VGA_LIB is
  ...
  -----------------------------------------------------------------------------
  -- CONSTANTS FOR BOXER PLACEMENTS
  constant LEFT_BOXER_X_START : integer := 127;
  constant LEFT_BOXER_X_END   : integer := 255;
  constant LEFT_BOXER_Y_START : integer := 191;
  constant LEFT_BOXER_Y_END   : integer := 447;

  constant RIGHT_BOXER_X_START : integer := 383;
  constant RIGHT_BOXER_X_END   : integer := 511;
  constant RIGHT_BOXER_Y_START : integer := 191;
  constant RIGHT_BOXER_Y_END   : integer := 447;

  -----------------------------------------------------------------------------
  -- CONSTANTS FOR BRICK PLACEMENTS

  constant TOP_BRICK_Y_START      : integer := 80;
  constant TOP_BRICK_Y_END        : integer := 112;
  constant BOTTOM_BRICK_Y_START   : integer := 448;
  constant BOTTOM_BRICK_Y_END     : integer := 479;
  constant BRICK_WIDTH            : integer := 32;
  constant BOXER_MEMORY_SIZE      : integer := 32768;
  constant CHUMBO_2_OFFSET        : integer := 16;
